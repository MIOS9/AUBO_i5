...
class ProtoJointInitData;
class ProtoJointInitDataResponse;
...
class ProtoJointInitData : public ::google::protobuf::Message {
 public:
  ProtoJointInitData();
  virtual ~ProtoJointInitData();

  ProtoJointInitData(const ProtoJointInitData& from);

  inline ProtoJointInitData& operator=(const ProtoJointInitData& from) {
    CopyFrom(from);
    return *this;
  }
  ...
  static const ::google::protobuf::Descriptor* descriptor();
  static const ProtoJointInitData& default_instance();

  void Swap(ProtoJointInitData* other);

  // implements Message ----------------------------------------------

  ProtoJointInitData* New() const;
  void CopyFrom(const ::google::protobuf::Message& from);
  void MergeFrom(const ::google::protobuf::Message& from);
  void CopyFrom(const ProtoJointInitData& from);
  void MergeFrom(const ProtoJointInitData& from);
  void Clear();
  bool IsInitialized() const;
  ...
  // required int32 JointSYS_ID = 1;
  inline bool has_jointsys_id() const;
  inline void clear_jointsys_id();
  static const int kJointSYSIDFieldNumber = 1;
  inline ::google::protobuf::int32 jointsys_id() const;
  inline void set_jointsys_id(::google::protobuf::int32 value);

  // required int32 JointModelType = 2;
  inline bool has_jointmodeltype() const;
  inline void clear_jointmodeltype();
  static const int kJointModelTypeFieldNumber = 2;
  inline ::google::protobuf::int32 jointmodeltype() const;
  inline void set_jointmodeltype(::google::protobuf::int32 value);

  // required int32 JointFWVer = 3;
  inline bool has_jointfwver() const;
  inline void clear_jointfwver();
  static const int kJointFWVerFieldNumber = 3;
  inline ::google::protobuf::int32 jointfwver() const;
  inline void set_jointfwver(::google::protobuf::int32 value);

  // required int32 JointReduRatio = 4;
  inline bool has_jointreduratio() const;
  inline void clear_jointreduratio();
  static const int kJointReduRatioFieldNumber = 4;
  inline ::google::protobuf::int32 jointreduratio() const;
  inline void set_jointreduratio(::google::protobuf::int32 value);

  // required int32 JointCANBaudrate = 5;
  inline bool has_jointcanbaudrate() const;
  inline void clear_jointcanbaudrate();
  static const int kJointCANBaudrateFieldNumber = 5;
  inline ::google::protobuf::int32 jointcanbaudrate() const;
  inline void set_jointcanbaudrate(::google::protobuf::int32 value);

  // required int32 JointEnableOnPower = 6;
  inline bool has_jointenableonpower() const;
  inline void clear_jointenableonpower();
  static const int kJointEnableOnPowerFieldNumber = 6;
  inline ::google::protobuf::int32 jointenableonpower() const;
  inline void set_jointenableonpower(::google::protobuf::int32 value);

  // required int32 JointRes = 7;
  inline bool has_jointres() const;
  inline void clear_jointres();
  static const int kJointResFieldNumber = 7;
  inline ::google::protobuf::int32 jointres() const;
  inline void set_jointres(::google::protobuf::int32 value);

  // required int32 JointInduc = 8;
  inline bool has_jointinduc() const;
  inline void clear_jointinduc();
  static const int kJointInducFieldNumber = 8;
  inline ::google::protobuf::int32 jointinduc() const;
  inline void set_jointinduc(::google::protobuf::int32 value);

  // required int32 JointRatedVol = 9;
  inline bool has_jointratedvol() const;
  inline void clear_jointratedvol();
  static const int kJointRatedVolFieldNumber = 9;
  inline ::google::protobuf::int32 jointratedvol() const;
  inline void set_jointratedvol(::google::protobuf::int32 value);

  // required int32 JointRatedCurrent = 10;
  inline bool has_jointratedcurrent() const;
  inline void clear_jointratedcurrent();
  static const int kJointRatedCurrentFieldNumber = 10;
  inline ::google::protobuf::int32 jointratedcurrent() const;
  inline void set_jointratedcurrent(::google::protobuf::int32 value);

  // required int32 JointEncLines = 11;
  inline bool has_jointenclines() const;
  inline void clear_jointenclines();
  static const int kJointEncLinesFieldNumber = 11;
  inline ::google::protobuf::int32 jointenclines() const;
  inline void set_jointenclines(::google::protobuf::int32 value);

  // required int32 JointHallValue = 12;
  inline bool has_jointhallvalue() const;
  inline void clear_jointhallvalue();
  static const int kJointHallValueFieldNumber = 12;
  inline ::google::protobuf::int32 jointhallvalue() const;
  inline void set_jointhallvalue(::google::protobuf::int32 value);

  // optional int32 JointThermistorValue = 13;
  inline bool has_jointthermistorvalue() const;
  inline void clear_jointthermistorvalue();
  static const int kJointThermistorValueFieldNumber = 13;
  inline ::google::protobuf::int32 jointthermistorvalue() const;
  inline void set_jointthermistorvalue(::google::protobuf::int32 value);

  // @@protoc_insertion_point(class_scope:aubo.robot.communication.ProtoJointInitData)
 private:
  inline void set_has_jointsys_id();
  inline void clear_has_jointsys_id();
  inline void set_has_jointmodeltype();
  inline void clear_has_jointmodeltype();
  inline void set_has_jointfwver();
  inline void clear_has_jointfwver();
  inline void set_has_jointreduratio();
  inline void clear_has_jointreduratio();
  inline void set_has_jointcanbaudrate();
  inline void clear_has_jointcanbaudrate();
  inline void set_has_jointenableonpower();
  inline void clear_has_jointenableonpower();
  inline void set_has_jointres();
  inline void clear_has_jointres();
  inline void set_has_jointinduc();
  inline void clear_has_jointinduc();
  inline void set_has_jointratedvol();
  inline void clear_has_jointratedvol();
  inline void set_has_jointratedcurrent();
  inline void clear_has_jointratedcurrent();
  inline void set_has_jointenclines();
  inline void clear_has_jointenclines();
  inline void set_has_jointhallvalue();
  inline void clear_has_jointhallvalue();
  inline void set_has_jointthermistorvalue();
  inline void clear_has_jointthermistorvalue();

  ::google::protobuf::UnknownFieldSet _unknown_fields_;

  ::google::protobuf::uint32 _has_bits_[1];
  mutable int _cached_size_;
  ::google::protobuf::int32 jointsys_id_;
  ::google::protobuf::int32 jointmodeltype_;
  ::google::protobuf::int32 jointfwver_;
  ::google::protobuf::int32 jointreduratio_;
  ::google::protobuf::int32 jointcanbaudrate_;
  ::google::protobuf::int32 jointenableonpower_;
  ::google::protobuf::int32 jointres_;
  ::google::protobuf::int32 jointinduc_;
  ::google::protobuf::int32 jointratedvol_;
  ::google::protobuf::int32 jointratedcurrent_;
  ::google::protobuf::int32 jointenclines_;
  ::google::protobuf::int32 jointhallvalue_;
  ::google::protobuf::int32 jointthermistorvalue_;
  friend void  protobuf_AddDesc_robotcommunication_2eproto();
  friend void protobuf_AssignDesc_robotcommunication_2eproto();
  friend void protobuf_ShutdownFile_robotcommunication_2eproto();

  void InitAsDefaultInstance();
  static ProtoJointInitData* default_instance_;
};
// -------------------------------------------------------------------

class ProtoJointInitDataResponse : public ::google::protobuf::Message {
 public:
  ProtoJointInitDataResponse();
  virtual ~ProtoJointInitDataResponse();

  ProtoJointInitDataResponse(const ProtoJointInitDataResponse& from);

  inline ProtoJointInitDataResponse& operator=(const ProtoJointInitDataResponse& from) {
    CopyFrom(from);
    return *this;
  }
  ...
  static const ::google::protobuf::Descriptor* descriptor();
  static const ProtoJointInitDataResponse& default_instance();

  void Swap(ProtoJointInitDataResponse* other);

  // implements Message ----------------------------------------------

  ProtoJointInitDataResponse* New() const;
  void CopyFrom(const ::google::protobuf::Message& from);
  void MergeFrom(const ::google::protobuf::Message& from);
  void CopyFrom(const ProtoJointInitDataResponse& from);
  void MergeFrom(const ProtoJointInitDataResponse& from);
  void Clear();
  bool IsInitialized() const;
  ...
  // repeated .aubo.robot.communication.ProtoJointInitData JointInitData = 1;
  inline int jointinitdata_size() const;
  inline void clear_jointinitdata();
  static const int kJointInitDataFieldNumber = 1;
  inline const ::aubo::robot::communication::ProtoJointInitData& jointinitdata(int index) const;
  inline ::aubo::robot::communication::ProtoJointInitData* mutable_jointinitdata(int index);
  inline ::aubo::robot::communication::ProtoJointInitData* add_jointinitdata();
  inline const ::google::protobuf::RepeatedPtrField< ::aubo::robot::communication::ProtoJointInitData >&
      jointinitdata() const;
  inline ::google::protobuf::RepeatedPtrField< ::aubo::robot::communication::ProtoJointInitData >*
      mutable_jointinitdata();
  ...
  // @@protoc_insertion_point(class_scope:aubo.robot.communication.ProtoJointInitDataResponse)
 private:
  inline void set_has_errorinfo();
  inline void clear_has_errorinfo();
  ...
  ::google::protobuf::uint32 _has_bits_[1];
  mutable int _cached_size_;
  ::google::protobuf::RepeatedPtrField< ::aubo::robot::communication::ProtoJointInitData > jointinitdata_;
  ::aubo::robot::communication::ProtoRobotCommonResponse* errorinfo_;
  friend void  protobuf_AddDesc_robotcommunication_2eproto();
  friend void protobuf_AssignDesc_robotcommunication_2eproto();
  friend void protobuf_ShutdownFile_robotcommunication_2eproto();
  ...
  void InitAsDefaultInstance();
  static ProtoJointInitDataResponse* default_instance_;
};
// ===================================================================
...
// required int32 JointSYS_ID = 1;
inline bool ProtoJointInitData::has_jointsys_id() const {
  return (_has_bits_[0] & 0x00000001u) != 0;
}
inline void ProtoJointInitData::set_has_jointsys_id() {
  _has_bits_[0] |= 0x00000001u;
}
inline void ProtoJointInitData::clear_has_jointsys_id() {
  _has_bits_[0] &= ~0x00000001u;
}
inline void ProtoJointInitData::clear_jointsys_id() {
  jointsys_id_ = 0;
  clear_has_jointsys_id();
}
inline ::google::protobuf::int32 ProtoJointInitData::jointsys_id() const {
  // @@protoc_insertion_point(field_get:aubo.robot.communication.ProtoJointInitData.JointSYS_ID)
  return jointsys_id_;
}
inline void ProtoJointInitData::set_jointsys_id(::google::protobuf::int32 value) {
  set_has_jointsys_id();
  jointsys_id_ = value;
  // @@protoc_insertion_point(field_set:aubo.robot.communication.ProtoJointInitData.JointSYS_ID)
}

// required int32 JointModelType = 2;
inline bool ProtoJointInitData::has_jointmodeltype() const {
  return (_has_bits_[0] & 0x00000002u) != 0;
}
inline void ProtoJointInitData::set_has_jointmodeltype() {
  _has_bits_[0] |= 0x00000002u;
}
inline void ProtoJointInitData::clear_has_jointmodeltype() {
  _has_bits_[0] &= ~0x00000002u;
}
inline void ProtoJointInitData::clear_jointmodeltype() {
  jointmodeltype_ = 0;
  clear_has_jointmodeltype();
}
inline ::google::protobuf::int32 ProtoJointInitData::jointmodeltype() const {
  // @@protoc_insertion_point(field_get:aubo.robot.communication.ProtoJointInitData.JointModelType)
  return jointmodeltype_;
}
inline void ProtoJointInitData::set_jointmodeltype(::google::protobuf::int32 value) {
  set_has_jointmodeltype();
  jointmodeltype_ = value;
  // @@protoc_insertion_point(field_set:aubo.robot.communication.ProtoJointInitData.JointModelType)
}

// required int32 JointFWVer = 3;
inline bool ProtoJointInitData::has_jointfwver() const {
  return (_has_bits_[0] & 0x00000004u) != 0;
}
inline void ProtoJointInitData::set_has_jointfwver() {
  _has_bits_[0] |= 0x00000004u;
}
inline void ProtoJointInitData::clear_has_jointfwver() {
  _has_bits_[0] &= ~0x00000004u;
}
inline void ProtoJointInitData::clear_jointfwver() {
  jointfwver_ = 0;
  clear_has_jointfwver();
}
inline ::google::protobuf::int32 ProtoJointInitData::jointfwver() const {
  // @@protoc_insertion_point(field_get:aubo.robot.communication.ProtoJointInitData.JointFWVer)
  return jointfwver_;
}
inline void ProtoJointInitData::set_jointfwver(::google::protobuf::int32 value) {
  set_has_jointfwver();
  jointfwver_ = value;
  // @@protoc_insertion_point(field_set:aubo.robot.communication.ProtoJointInitData.JointFWVer)
}

// required int32 JointReduRatio = 4;
inline bool ProtoJointInitData::has_jointreduratio() const {
  return (_has_bits_[0] & 0x00000008u) != 0;
}
inline void ProtoJointInitData::set_has_jointreduratio() {
  _has_bits_[0] |= 0x00000008u;
}
inline void ProtoJointInitData::clear_has_jointreduratio() {
  _has_bits_[0] &= ~0x00000008u;
}
inline void ProtoJointInitData::clear_jointreduratio() {
  jointreduratio_ = 0;
  clear_has_jointreduratio();
}
inline ::google::protobuf::int32 ProtoJointInitData::jointreduratio() const {
  // @@protoc_insertion_point(field_get:aubo.robot.communication.ProtoJointInitData.JointReduRatio)
  return jointreduratio_;
}
inline void ProtoJointInitData::set_jointreduratio(::google::protobuf::int32 value) {
  set_has_jointreduratio();
  jointreduratio_ = value;
  // @@protoc_insertion_point(field_set:aubo.robot.communication.ProtoJointInitData.JointReduRatio)
}

// required int32 JointCANBaudrate = 5;
inline bool ProtoJointInitData::has_jointcanbaudrate() const {
  return (_has_bits_[0] & 0x00000010u) != 0;
}
inline void ProtoJointInitData::set_has_jointcanbaudrate() {
  _has_bits_[0] |= 0x00000010u;
}
inline void ProtoJointInitData::clear_has_jointcanbaudrate() {
  _has_bits_[0] &= ~0x00000010u;
}
inline void ProtoJointInitData::clear_jointcanbaudrate() {
  jointcanbaudrate_ = 0;
  clear_has_jointcanbaudrate();
}
inline ::google::protobuf::int32 ProtoJointInitData::jointcanbaudrate() const {
  // @@protoc_insertion_point(field_get:aubo.robot.communication.ProtoJointInitData.JointCANBaudrate)
  return jointcanbaudrate_;
}
inline void ProtoJointInitData::set_jointcanbaudrate(::google::protobuf::int32 value) {
  set_has_jointcanbaudrate();
  jointcanbaudrate_ = value;
  // @@protoc_insertion_point(field_set:aubo.robot.communication.ProtoJointInitData.JointCANBaudrate)
}

// required int32 JointEnableOnPower = 6;
inline bool ProtoJointInitData::has_jointenableonpower() const {
  return (_has_bits_[0] & 0x00000020u) != 0;
}
inline void ProtoJointInitData::set_has_jointenableonpower() {
  _has_bits_[0] |= 0x00000020u;
}
inline void ProtoJointInitData::clear_has_jointenableonpower() {
  _has_bits_[0] &= ~0x00000020u;
}
inline void ProtoJointInitData::clear_jointenableonpower() {
  jointenableonpower_ = 0;
  clear_has_jointenableonpower();
}
inline ::google::protobuf::int32 ProtoJointInitData::jointenableonpower() const {
  // @@protoc_insertion_point(field_get:aubo.robot.communication.ProtoJointInitData.JointEnableOnPower)
  return jointenableonpower_;
}
inline void ProtoJointInitData::set_jointenableonpower(::google::protobuf::int32 value) {
  set_has_jointenableonpower();
  jointenableonpower_ = value;
  // @@protoc_insertion_point(field_set:aubo.robot.communication.ProtoJointInitData.JointEnableOnPower)
}

// required int32 JointRes = 7;
inline bool ProtoJointInitData::has_jointres() const {
  return (_has_bits_[0] & 0x00000040u) != 0;
}
inline void ProtoJointInitData::set_has_jointres() {
  _has_bits_[0] |= 0x00000040u;
}
inline void ProtoJointInitData::clear_has_jointres() {
  _has_bits_[0] &= ~0x00000040u;
}
inline void ProtoJointInitData::clear_jointres() {
  jointres_ = 0;
  clear_has_jointres();
}
inline ::google::protobuf::int32 ProtoJointInitData::jointres() const {
  // @@protoc_insertion_point(field_get:aubo.robot.communication.ProtoJointInitData.JointRes)
  return jointres_;
}
inline void ProtoJointInitData::set_jointres(::google::protobuf::int32 value) {
  set_has_jointres();
  jointres_ = value;
  // @@protoc_insertion_point(field_set:aubo.robot.communication.ProtoJointInitData.JointRes)
}

// required int32 JointInduc = 8;
inline bool ProtoJointInitData::has_jointinduc() const {
  return (_has_bits_[0] & 0x00000080u) != 0;
}
inline void ProtoJointInitData::set_has_jointinduc() {
  _has_bits_[0] |= 0x00000080u;
}
inline void ProtoJointInitData::clear_has_jointinduc() {
  _has_bits_[0] &= ~0x00000080u;
}
inline void ProtoJointInitData::clear_jointinduc() {
  jointinduc_ = 0;
  clear_has_jointinduc();
}
inline ::google::protobuf::int32 ProtoJointInitData::jointinduc() const {
  // @@protoc_insertion_point(field_get:aubo.robot.communication.ProtoJointInitData.JointInduc)
  return jointinduc_;
}
inline void ProtoJointInitData::set_jointinduc(::google::protobuf::int32 value) {
  set_has_jointinduc();
  jointinduc_ = value;
  // @@protoc_insertion_point(field_set:aubo.robot.communication.ProtoJointInitData.JointInduc)
}

// required int32 JointRatedVol = 9;
inline bool ProtoJointInitData::has_jointratedvol() const {
  return (_has_bits_[0] & 0x00000100u) != 0;
}
inline void ProtoJointInitData::set_has_jointratedvol() {
  _has_bits_[0] |= 0x00000100u;
}
inline void ProtoJointInitData::clear_has_jointratedvol() {
  _has_bits_[0] &= ~0x00000100u;
}
inline void ProtoJointInitData::clear_jointratedvol() {
  jointratedvol_ = 0;
  clear_has_jointratedvol();
}
inline ::google::protobuf::int32 ProtoJointInitData::jointratedvol() const {
  // @@protoc_insertion_point(field_get:aubo.robot.communication.ProtoJointInitData.JointRatedVol)
  return jointratedvol_;
}
inline void ProtoJointInitData::set_jointratedvol(::google::protobuf::int32 value) {
  set_has_jointratedvol();
  jointratedvol_ = value;
  // @@protoc_insertion_point(field_set:aubo.robot.communication.ProtoJointInitData.JointRatedVol)
}

// required int32 JointRatedCurrent = 10;
inline bool ProtoJointInitData::has_jointratedcurrent() const {
  return (_has_bits_[0] & 0x00000200u) != 0;
}
inline void ProtoJointInitData::set_has_jointratedcurrent() {
  _has_bits_[0] |= 0x00000200u;
}
inline void ProtoJointInitData::clear_has_jointratedcurrent() {
  _has_bits_[0] &= ~0x00000200u;
}
inline void ProtoJointInitData::clear_jointratedcurrent() {
  jointratedcurrent_ = 0;
  clear_has_jointratedcurrent();
}
inline ::google::protobuf::int32 ProtoJointInitData::jointratedcurrent() const {
  // @@protoc_insertion_point(field_get:aubo.robot.communication.ProtoJointInitData.JointRatedCurrent)
  return jointratedcurrent_;
}
inline void ProtoJointInitData::set_jointratedcurrent(::google::protobuf::int32 value) {
  set_has_jointratedcurrent();
  jointratedcurrent_ = value;
  // @@protoc_insertion_point(field_set:aubo.robot.communication.ProtoJointInitData.JointRatedCurrent)
}

// required int32 JointEncLines = 11;
inline bool ProtoJointInitData::has_jointenclines() const {
  return (_has_bits_[0] & 0x00000400u) != 0;
}
inline void ProtoJointInitData::set_has_jointenclines() {
  _has_bits_[0] |= 0x00000400u;
}
inline void ProtoJointInitData::clear_has_jointenclines() {
  _has_bits_[0] &= ~0x00000400u;
}
inline void ProtoJointInitData::clear_jointenclines() {
  jointenclines_ = 0;
  clear_has_jointenclines();
}
inline ::google::protobuf::int32 ProtoJointInitData::jointenclines() const {
  // @@protoc_insertion_point(field_get:aubo.robot.communication.ProtoJointInitData.JointEncLines)
  return jointenclines_;
}
inline void ProtoJointInitData::set_jointenclines(::google::protobuf::int32 value) {
  set_has_jointenclines();
  jointenclines_ = value;
  // @@protoc_insertion_point(field_set:aubo.robot.communication.ProtoJointInitData.JointEncLines)
}

// required int32 JointHallValue = 12;
inline bool ProtoJointInitData::has_jointhallvalue() const {
  return (_has_bits_[0] & 0x00000800u) != 0;
}
inline void ProtoJointInitData::set_has_jointhallvalue() {
  _has_bits_[0] |= 0x00000800u;
}
inline void ProtoJointInitData::clear_has_jointhallvalue() {
  _has_bits_[0] &= ~0x00000800u;
}
inline void ProtoJointInitData::clear_jointhallvalue() {
  jointhallvalue_ = 0;
  clear_has_jointhallvalue();
}
inline ::google::protobuf::int32 ProtoJointInitData::jointhallvalue() const {
  // @@protoc_insertion_point(field_get:aubo.robot.communication.ProtoJointInitData.JointHallValue)
  return jointhallvalue_;
}
inline void ProtoJointInitData::set_jointhallvalue(::google::protobuf::int32 value) {
  set_has_jointhallvalue();
  jointhallvalue_ = value;
  // @@protoc_insertion_point(field_set:aubo.robot.communication.ProtoJointInitData.JointHallValue)
}

// optional int32 JointThermistorValue = 13;
inline bool ProtoJointInitData::has_jointthermistorvalue() const {
  return (_has_bits_[0] & 0x00001000u) != 0;
}
inline void ProtoJointInitData::set_has_jointthermistorvalue() {
  _has_bits_[0] |= 0x00001000u;
}
inline void ProtoJointInitData::clear_has_jointthermistorvalue() {
  _has_bits_[0] &= ~0x00001000u;
}
inline void ProtoJointInitData::clear_jointthermistorvalue() {
  jointthermistorvalue_ = 0;
  clear_has_jointthermistorvalue();
}
inline ::google::protobuf::int32 ProtoJointInitData::jointthermistorvalue() const {
  // @@protoc_insertion_point(field_get:aubo.robot.communication.ProtoJointInitData.JointThermistorValue)
  return jointthermistorvalue_;
}
inline void ProtoJointInitData::set_jointthermistorvalue(::google::protobuf::int32 value) {
  set_has_jointthermistorvalue();
  jointthermistorvalue_ = value;
  // @@protoc_insertion_point(field_set:aubo.robot.communication.ProtoJointInitData.JointThermistorValue)
}
...
// repeated .aubo.robot.communication.ProtoJointInitData JointInitData = 1;
inline int ProtoJointInitDataResponse::jointinitdata_size() const {
  return jointinitdata_.size();
}
inline void ProtoJointInitDataResponse::clear_jointinitdata() {
  jointinitdata_.Clear();
}
inline const ::aubo::robot::communication::ProtoJointInitData& ProtoJointInitDataResponse::jointinitdata(int index) const {
  // @@protoc_insertion_point(field_get:aubo.robot.communication.ProtoJointInitDataResponse.JointInitData)
  return jointinitdata_.Get(index);
}
inline ::aubo::robot::communication::ProtoJointInitData* ProtoJointInitDataResponse::mutable_jointinitdata(int index) {
  // @@protoc_insertion_point(field_mutable:aubo.robot.communication.ProtoJointInitDataResponse.JointInitData)
  return jointinitdata_.Mutable(index);
}
inline ::aubo::robot::communication::ProtoJointInitData* ProtoJointInitDataResponse::add_jointinitdata() {
  // @@protoc_insertion_point(field_add:aubo.robot.communication.ProtoJointInitDataResponse.JointInitData)
  return jointinitdata_.Add();
}
inline const ::google::protobuf::RepeatedPtrField< ::aubo::robot::communication::ProtoJointInitData >&
ProtoJointInitDataResponse::jointinitdata() const {
  // @@protoc_insertion_point(field_list:aubo.robot.communication.ProtoJointInitDataResponse.JointInitData)
  return jointinitdata_;
}
inline ::google::protobuf::RepeatedPtrField< ::aubo::robot::communication::ProtoJointInitData >*
ProtoJointInitDataResponse::mutable_jointinitdata() {
  // @@protoc_insertion_point(field_mutable_list:aubo.robot.communication.ProtoJointInitDataResponse.JointInitData)
  return &jointinitdata_;
}

// required .aubo.robot.communication.ProtoRobotCommonResponse errorInfo = 2;
inline bool ProtoJointInitDataResponse::has_errorinfo() const {
  return (_has_bits_[0] & 0x00000002u) != 0;
}
inline void ProtoJointInitDataResponse::set_has_errorinfo() {
  _has_bits_[0] |= 0x00000002u;
}
inline void ProtoJointInitDataResponse::clear_has_errorinfo() {
  _has_bits_[0] &= ~0x00000002u;
}
inline void ProtoJointInitDataResponse::clear_errorinfo() {
  if (errorinfo_ != NULL) errorinfo_->::aubo::robot::communication::ProtoRobotCommonResponse::Clear();
  clear_has_errorinfo();
}
inline const ::aubo::robot::communication::ProtoRobotCommonResponse& ProtoJointInitDataResponse::errorinfo() const {
  // @@protoc_insertion_point(field_get:aubo.robot.communication.ProtoJointInitDataResponse.errorInfo)
  return errorinfo_ != NULL ? *errorinfo_ : *default_instance_->errorinfo_;
}
inline ::aubo::robot::communication::ProtoRobotCommonResponse* ProtoJointInitDataResponse::mutable_errorinfo() {
  set_has_errorinfo();
  if (errorinfo_ == NULL) errorinfo_ = new ::aubo::robot::communication::ProtoRobotCommonResponse;
  // @@protoc_insertion_point(field_mutable:aubo.robot.communication.ProtoJointInitDataResponse.errorInfo)
  return errorinfo_;
}
inline ::aubo::robot::communication::ProtoRobotCommonResponse* ProtoJointInitDataResponse::release_errorinfo() {
  clear_has_errorinfo();
  ::aubo::robot::communication::ProtoRobotCommonResponse* temp = errorinfo_;
  errorinfo_ = NULL;
  return temp;
}
inline void ProtoJointInitDataResponse::set_allocated_errorinfo(::aubo::robot::communication::ProtoRobotCommonResponse* errorinfo) {
  delete errorinfo_;
  errorinfo_ = errorinfo;
  if (errorinfo) {
    set_has_errorinfo();
  ...
  // @@protoc_insertion_point(field_set_allocated:aubo.robot.communication.ProtoJointInitDataResponse.errorInfo)
}
